...
module.exports = {
    ...
    "Should have all the containers and children"(client) {
        client
            .url("http://localhost:8080/examples/layout/child-bottom.html")
    ...
    "Mobile: Should see child-a at bottom"(client) {
        client
            .url("http://localhost:8080/examples/layout/child-bottom.html")
    ...
    "Tablet: Should see child-a at right"(client) {
        client
            .url("http://localhost:8080/examples/layout/child-bottom.html")
    ...
    "desktop: Should see child-a at bottom"(client) {
        client
            .url("http://localhost:8080/examples/layout/child-bottom.html")
    ...
    "Big Screen: Should see child-a at right"(client) {
        client
            .url("http://localhost:8080/examples/layout/child-bottom.html")
